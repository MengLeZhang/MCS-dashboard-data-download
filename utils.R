## Unzip files and create a master dataset 
...
la_box <- 
  function(la_n){
    ## For the LA the xpath in the box has a pattern where li[N] where N is the id of the tick box
